	...
	<div class="container">
		<div class="row row-offcanvas row-offcanvas-right">
			...
			<div class="col-xs-12">
				...
				<table class="table">
					<form action="<?php echo base_url()?>index.php/app/edit_action/<?php echo $dataLokasi->lokasi_kerja_id ?>" method="POST">
						<input type="hidden" name="lokasi_kerja_id" value="<?php echo $dataLokasi->lokasi_kerja_id ?>">
						<tr>
							<td>Name</td>
							<td>:</td>
							<td><input type="text" name="lokasi_kerja_nama" value="<?php echo $dataLokasi->lokasi_kerja_nama ?>" class="form-control"></td>
						</tr>
						<tr>
