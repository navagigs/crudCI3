			...
			<div class="col-xs-12">
				...
				<script>
					function validateForm() {
						var x = document.forms["validasiForm"]["lokasi_kerja_nama"].value;
						if (x == "") {
							alert("Nama Lokasi Kerja harus diisi!");
							return false;
						}
					}
				</script>
				<table class="table">
					<form name="validasiForm" action="<?php echo base_url()?>index.php/app/add_action" onsubmit="return validateForm()" method="POST">
						<tr>
							<td>Name</td>
							<td>:</td>
							<td><input type="text" name="lokasi_kerja_nama" id="lokasi_kerja_nama" class="form-control"></td>
						</tr>
						<tr>
